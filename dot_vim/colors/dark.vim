...
hi CursorLine term=NONE cterm=bold ctermbg=236
hi Folded ctermbg=7 ctermfg=4
hi FoldColumn ctermbg=0 ctermfg=4
hi Visual term=NONE cterm=bold ctermbg=031 ctermfg=51
hi Search term=reverse cterm=bold ctermbg=130 ctermfg=0
hi Function ctermbg=233 ctermfg=85
" ===
